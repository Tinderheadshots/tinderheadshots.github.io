...
var wpAjaxUrl='http://tinderheadshots.nuepage.com/wp-admin/admin-ajax.php';var flBuilderUrl='http://tinderheadshots.nuepage.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://tinderheadshots.nuepage.com/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://tinderheadshots.nuepage.com/wp-admin/admin-ajax.php'},breakpoints:{small:850,medium:1440},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){$(function(){$('.fl-node-5a0de9f318cfe .fl-mosaicflow-content').one('filled',function(){var hash=window.location.hash.replace('#','');if(hash!=''){FLBuilderLayout._scrollToElement($('#'+hash));}
